module.exports = {
  "get/listSpaces": {
    PositiveTest: {
      ...
      footer:
        "export {getlistSpacesPositiveTest, method, requestBody, expectedOutput, path};",
      test:
  ...
  "get/permission": {
    PositiveTest: {
      ...
      footer:
        "export {getpermissionPositiveTest, method, requestBody, expectedOutput, path};",
      test:
        "function() {return api[method.toLowerCase()](endpoint + path, requestBody)}"
    }
  },
  "post/spaces": {
    PositiveTest: {
      ...
      footer:
        "export {postspacesPositiveTest, method, requestBody, expectedOutput, path};",
      test:
        "function() {return api[method.toLowerCase()](endpoint + path, requestBody)}"
    }
  },
  "get/spaces/{id}": {
    PositiveTest: {
      ...
      footer:
        "export {getspacesplPositiveTest, method, requestBody, expectedOutput, path};",
      test:
        "function() {return api[method.toLowerCase()](endpoint + path, requestBody)}"
    }
  },
  "delete/spaces/{id}": {
    PositiveTest: {
      ...
      footer:
        "export {delspacesSfePositiveTest, method, requestBody, expectedOutput, path};",
      test:
        "function() {return api[method.toLowerCase()](endpoint + path, requestBody)}"
    }
  },
  "patch/spaces/{id}": {
    PositiveTest: {
      ...
      footer:
        "export {patchspacesCVtpvZmXRhaPositiveTest, method, requestBody, expectedOutput, path};",
      test:
        "function() {return api[method.toLowerCase()](endpoint + path, requestBody)}"
    }
  }
